<html>
   ...
   along with this program.  If not, see <http://www.gnu.org/licenses/>. --> 
    <head>
        ...
        <script src="../javascript/permutations/grid_1104.js"></script>
        <script src="../javascript/permutations/grid_2208.js"></script>
        <script src="../javascript/permutations/grid_4416.js"></script>
        <script src="../javascript/permutations/grid_8832.js"></script>
        <script src="../javascript/permutations/grid_17664.js"></script>
        <script src="../javascript/permutations/grid_35328.js"></script>
        <script src="../javascript/permutations/grid_70656.js"></script>
        <script src="../javascript/permutations/grid_141312.js"></script>
        <script src="../javascript/permutations/grid_282624.js"></script>
        <script src="../javascript/permutations/grid_565248.js"></script>
        <script src="../javascript/permutations/grid_1130496.js"></script>
        <script src="../javascript/permutations/grid_2260992.js"></script>
        <script src="../javascript/permutations/grid_4521984.js"></script>
        <!--<script src="../javascript/permutations/grid_9043968.js"></script>
        <script src="../javascript/permutations/grid_18087936.js"></script>
        <script src="../javascript/permutations/grid_36175872.js"></script>-->
...
<?php // reset markers icons to default                  ?>
        ...
        <div id='container1'> <!-- div container -->
            ...
            <form class="curvesettings">
                ...
                <div class="box legend" id="profile">
                    <div class="title">Profile</div>
                    <input type="radio" name="profile" value="all" onclick="redraw()">all<br>
                    <input type="radio" name="profile" value="citizen" onclick="redraw()">citizen<br>
                    <input type="radio" name="profile" value="commuter" onclick="redraw()">commuter<br>
                    <input type="radio" name="profile" value="student" onclick="redraw()">student<br>
                    <input type="radio" name="profile" value="tourist" checked onclick="redraw()">tourist<br>
                    <input type="radio" name="profile" value="disabled" onclick="redraw()">disabled<br>
                    <input type="radio" name="profile" value="operator" onclick="redraw()">operator<br>
                    <input type="radio" name="profile" value="" onclick="redraw()">global
                </div>
                <div class="box legend" id="hour">
                    ...
                    <input type="radio" name="hour" value="10" checked onclick="redraw()">10&nbsp;
                    ...
                    <input type="radio" name="hour" value="" onclick="redraw()">All
                </div>
                <div class="box legend">
...
?>
        /*$("#od").replaceWith(function () {
         ...
         return "<a href=\"./adj/adj.php?profile=tourist&hour=10&cluster=1104\" style=\"font-size: 12px;\">OD Matrix</a>";
         });*/

<?php // load csv, draw circles and flows
?>
        $.ajax({
        url: "./permutations/links_" + (profile != "" ? profile + "_" : "") + (hour != "" ? hour + "_" : "") + clusterSize + ".csv",
                async: true,
...
<?php // set OD matrix link in legend
?>
        var profile_p = profile != "" ? "&profile=" + profile : "";
                var hour_p = hour != "" ? "&hour=" + hour : "";
                var radius_p = radius != 0 ? "&radius=" + radius : "";
                $("#od").attr("href", "./adj/adj.php?cluster=" + clusterSize + profile_p + hour_p + radius_p + "&title=<?php echo urlencode("Recommender - Origin Destination matrix for People Flows&nbsp;"); ?>");
                $.getJSON("./permutations/nodes_" + (profile != "" ? profile + "_" : "") + (hour != "" ? hour + "_" : "") + clusterSize + ".geojson").done(function (data) {
...
?>
        var profile_p = profile != "" ? "&profile=" + profile : "";
                var hour_p = hour != "" ? "&hour=" + hour : "";
                var radius_p = radius != 0 ? "&radius=" + radius : "";
                $("#od").attr("href", "./adj/adj.php?cluster=" + clusterSize + profile_p + hour_p + radius_p + "&title=<?php echo urlencode("Origin Destination matrix for People Flows&nbsp;"); ?>");
        }
