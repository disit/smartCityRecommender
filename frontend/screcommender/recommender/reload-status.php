        ...
        <div id='filtersTable'>
            <table>
                <tr class='even'>
                    ...
                    <td><input type="text" name="FILTER_TEST_USER" class="FILTER" id="FILTER_TEST_USER"></td>
                    <td><input type="text" name="FILTER_PROFILE" class="FILTER" id="FILTER_PROFILE"></td>
                    <td><input type="text" name="FILTER_RECS_TOTAL" class="FILTER" id="FILTER_RECS_TOTAL"></td>
                    <td><input type="text" name="FILTER_RECS_TODAY" class="FILTER" id="FILTER_RECS_TODAY"></td>
                    <td><input type="text" name="FILTER_RECS_ACCEPTED" class="FILTER" id="FILTER_RECS_ACCEPTED"></td>
                    <td><input type="text" name="FILTER_ACTIVE_DAYS" class="FILTER" id="FILTER_ACTIVE_DAYS"></td>
                    <td><input type="text" name="FILTER_ACTIVE_LOCATIONS" class="FILTER" id="FILTER_ACTIVE_LOCATIONS"></td>
                    ...
                    <td><input type="text" name="FILTER_MODE" class="FILTER" id="FILTER_MODE"></td>
