...
if (isset($_REQUEST["profile"])) {
    $parameters[] = "profile=" . $_REQUEST["profile"];
}
        ...
        <div class="container"> <!-- container -->
            <div class="rows"> <!-- container -->
                ...
                <script>
                    ...
                    $.getJSON("<?php echo "../permutations/nodes" . getFilename() . ".geojson"; ?>", function (data) {
                    }).done(function (data) {
                    ...
                    /*function getCSV(csv) {
                     $.ajax({
                     url: "<?php /* echo "../permutations/links" . getFilename() . ".csv"; */ ?>",
